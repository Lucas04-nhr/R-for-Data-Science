...
data_list =
  list(
    data.frame(Name = "John", Key = "Age", Value = "30"),
    data.frame(Name = "John", Key = "Sex", Value = "M"),
    data.frame(Name = "Mary", Key = "Sex", Value = "F"),
    data.frame(Name = "John", Key = "Treatment", Value = "A")
  )
...
result_tidyverse$Age = 
  as.numeric(result_tidyverse$Age)
