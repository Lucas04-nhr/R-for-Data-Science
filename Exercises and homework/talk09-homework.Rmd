...
p4 =
  ...
  scale_y_continuous(expand = c(0.01,max(mtcars_arranged$mpg)/3)) +
  geom_bar(stat = "identity") +
  coord_polar(theta = "x") + 
  # Change the 
  geom_text(
    aes(x = 1:length(mtcars_arranged$car_name),
        label = mtcars_arranged$car_name,
        angle = mtcars_arranged$angle,
        hjust = -0.05
      )
  ) +
