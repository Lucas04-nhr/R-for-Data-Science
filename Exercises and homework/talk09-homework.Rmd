...
mtcars_arranged$car_name =
  factor(mtcars_arranged$car_name, levels = mtcars_arranged$car_name)
...
p4 =
  ggplot(mtcars_arranged, aes(x = car_name, y = mpg, fill = factor(cyl))) +
...
plot_grid(p1, p2, p4, lables = c("A", "B", "C"),ncol = 2,nrow = 2)
```
