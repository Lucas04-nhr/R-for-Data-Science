...
scatter_plot_with_regression =
  ...
  # AWAITING PERFECTION
  # annotate("text", x = 4, y = 30, label = paste("Correlation:", round(correlation, 2)))  
...
# Print the scatter plot with regression
